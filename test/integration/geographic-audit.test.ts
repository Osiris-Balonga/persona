...
describe('geographic catalog audit', () => {
  it('samples every resident-eligible ISO code and lists gaps without claiming manual review', () => {
    ...
    expect(report).toMatchObject({ dataVersion: 'geo-2026-09-24.16', registryCodes: 249, eligibleCodes: 242,
      unavailableCodes: 7, profileEligibleCodes: 18, pendingNameReviewCodes: 224, sampledCodes: 242, errors: [] })
