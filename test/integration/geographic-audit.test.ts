...
describe('geographic catalog audit', () => {
  it('samples every resident-eligible ISO code and lists gaps without claiming manual review', () => {
    ...
    expect(report).toMatchObject({ dataVersion: 'geo-2026-09-24.13', registryCodes: 249, eligibleCodes: 242,
      unavailableCodes: 7, profileEligibleCodes: 12, pendingNameReviewCodes: 230, sampledCodes: 242, errors: [] })
