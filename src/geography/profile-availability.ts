...
const reviewedNameCodes = new Set(['AO', 'BF', 'BI', 'BJ', 'BT', 'BW', 'CD', 'CG', 'CI', 'CM', 'CV', 'DZ', 'EG', 'ET', 'GA', 'GH', 'GM', 'GN', 'GQ', 'KE', 'LR', 'LS', 'MA', 'MG', 'ML', 'MM', 'MW', 'MZ', 'NA', 'NG', 'RE', 'RW', 'SC', 'SL', 'SN', 'TG', 'TN', 'TZ', 'UG', 'ZA', 'ZM', 'ZW'])
