...
const reviewedNameCodes = new Set(['AO', 'BF', 'BI', 'BJ', 'BT', 'BW', 'CD', 'CF', 'CG', 'CI', 'CM', 'CV', 'DZ', 'EG', 'ET', 'GA', 'GH', 'GM', 'GN', 'GQ', 'KE', 'LR', 'LS', 'LY', 'MA', 'MG', 'ML', 'MM', 'MU', 'MW', 'MZ', 'NA', 'NG', 'RE', 'RW', 'SC', 'SD', 'SL', 'SN', 'SO', 'SS', 'TG', 'TN', 'TZ', 'UG', 'YT', 'ZA', 'ZM', 'ZW'])
