...
Run `npm run data:audit:beta` to repeat this audit against the current code and data. The integration suite runs the same checks in CI. This snapshot uses geographic data version `geo-2026-09-25.12` and portrait catalog `empty-v1`.
